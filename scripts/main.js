;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA JASMINE SAYANG :)','JANGAN LUPA', 'BUKA DI LAPTOP','PELAN-PELAN IAA', 'SAYANG', 'COBA LIHAT DEH', 'KOK KATA-KATA INI', 'TERKESAN ANEH YA', 'COBA PENCET LAGI', 'SEKALI LAGI', 'TERAKHIR JANJI', 'AKU TAHU KAMU PASTI KESAL NGEKLIK MULU', 'AKU', 'SAYANG', 'KAMU ♡', 'RIYAL 100% ', 'AKU GATAU LAGI HARUS', 'DENGAN APA AKU', 'MENUNJUKKAN RASA SAYANG INI', 'SEJUJURNYA', 'AKU TAKUT KAMU PERGI', 'AKU JUGA BISA ', 'NGELAKUIN APA AJA', 'BUAT KAMU', 'TAPI AKU NGERASA', 'KAYA GA ADIL', 'AKU JUGA MAU', 'DISAYANG 100%', 'SEMOGA ITU BISA TERCAPAI', 'AKU AKAN MENUNGGU', 'SELALU MENUNGGU','AKU SUKA NGELARANG KAMU','KARENA AKU SAYANG','CAPE YA :V','MAKASIH UDAH KLIK SAMPAI AKHIR SAYANG']
